...
**Github repo: https://github.com/maya-leblanc/tf_sensor_ros2**

<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/projects/tf_sens_1.jpg" title="Robot and obstacles in Gazebo Harmonic, RViz2, and teleoperation in terminal" class="img-fluid rounded z-depth-1" %}
    </div>
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/projects/tf_sens_2.jpg" title="TF tree in RViz" class="img-fluid rounded z-depth-1" %}
    </div>
</div>

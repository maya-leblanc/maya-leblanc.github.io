...
<div class="row justify-content-sm-center">
    <div class="col-sm-8 mt-3 mt-md-0">
        {% include figure.liquid path="assets/img/projects/project_aura.jpg" title="Project AURA" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
    Project AURA — independent research through Aletheia.
</div>

**Tools:** computer engineering, neuroscience, biomedical engineering.
...
- **Full-stack integration:** I owned the entire pipeline — BCI software configuration, Python signal processing, embedded C++ firmware, and the physical mechanical build — rather than working in a single layer of the stack.
- **Human factors:** I added environmental sensing specifically because extended prosthetic wear causes heat buildup and skin irritation, a constraint that only becomes apparent when designing for real daily use rather than a lab demo.

### Result

A working prototype that opens and closes a robotic hand from trained mental commands alone, with real-time environmental monitoring for wearer comfort. Full technical documentation, safety information, and source code are available on GitHub.
...
The system worked best when I was completely focused and calm — distractions or mental fatigue noticeably degraded response accuracy, which underscored how sensitive and personal brain-computer interfaces really are. Looking ahead, I'd like to add more distinct mental commands and reduce response latency further.
